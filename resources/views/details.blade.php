                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="no">01</td>
                      <td class="text-left">
                        <h3><a target="_blank" href="javascript:;">{{$invoice->designation_title}}</a></h3>
                        {{$invoice->designation_detail}} 
                      </td>
                      <td class="unit">$ {{$invoice->unit_price}} </td>
                      <td class="qty">{{$invoice->quantity}}</td>
                      <td class="total">${{$invoice->unit_price}}</td>
                    </tr>
