        ...
        <form action="{{route('updatedecharge')}}" method="post">
            @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="client_name" id="client_name" value="{{$decharge->client_name}}" >
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="amout_received" id="amout_received" value="{{$decharge->amout_received}}">
                </div>
                <div class="mb-3">
                    <label for="motif" class="form-label">Objet:</label>
                    <input type="text" class="form-control" name="motif" id="motif" value="{{$decharge->motif}}">
                </div>
